...
class AlleleMatrix {
 public:
    ...
    // distance methods
    pybind11::array_t<int> hamming( bool fill_cache ) const;
    pybind11::array_t<int> hammingSIMD( bool fill_cache ) const;
    ...
    pybind11::list findSharedSNPGUIDs( size_t row_coord, int k_snps ) const;
    pybind11::list findSharedSNPGUIDsSIMD( size_t row_coord, int k_snps ) const;
