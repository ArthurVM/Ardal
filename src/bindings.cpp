...
PYBIND11_MODULE(_ardal, m) {  // _ardal module and function bindings
    py::class_<_ardal::HybridMatrix>(m, "HybridMatrix")
        ...
        .def("hamming", &_ardal::HybridMatrix::hamming,
            py::arg("use_simd") = true,
            py::arg("threads") = 1,
            py::arg("backend") = "auto")

        .def("hamming_subset", &_ardal::HybridMatrix::hamming_subset,
            py::arg("row_indices"),
            py::arg("col_indices"),
            py::arg("use_simd") = true,
            py::arg("threads") = 1,
        ...
        .def("jaccard", &_ardal::HybridMatrix::jaccard,
            py::arg("use_simd") = true,
            py::arg("threads") = 1,
            py::arg("backend") = "auto")

        .def("innerProduct", &_ardal::HybridMatrix::innerProduct,
            py::arg("use_simd") = true,
            py::arg("threads") = 1,
            py::arg("backend") = "auto")

        .def("neighbourhood", &_ardal::HybridMatrix::neighbourhood,
            py::arg("row_idx"),
            py::arg("epsilon"),
            py::arg("use_simd") = true,
            py::arg("threads") = 1,
        ...
        .def("innerProductNeighbourhood", &_ardal::HybridMatrix::innerProductNeighbourhood,
            py::arg("row_idx"),
            py::arg("ip_epsilon"),
            py::arg("use_simd") = true,
            py::arg("backend") = "auto")

        .def("uniqueSharedBits", &_ardal::HybridMatrix::uniqueSharedBits,
            py::arg("row_indices"),
            py::arg("use_simd") = true,
            py::arg("backend") = "auto")
        ...
        // BitMatrix only
        .def("colFrequency", &_ardal::HybridMatrix::colFrequency,
            py::arg("row_indices"))

        .def("columnEntropy", &_ardal::HybridMatrix::columnEntropy)

        .def("klDivergence", &_ardal::HybridMatrix::klDivergence,
            py::arg("ingroup_indices"))

        .def("jsDivergence", &_ardal::HybridMatrix::jsDivergence,
            py::arg("ingroup_indices"))

        .def("informationGain", &_ardal::HybridMatrix::informationGain,
            py::arg("ingroup_indices"))

        .def("getSetBitIndices", &_ardal::HybridMatrix::getSetBitIndices,
            py::arg("row_idx"),
            py::arg("backend") = "auto")
        ...
        .def("bitCooccurrence_all", &_ardal::HybridMatrix::bitCooccurrence_all,
            py::arg("threshold") = 0.95,
            py::arg("threads") = 1)

        .def("bitCooccurrence_subset", &_ardal::HybridMatrix::bitCooccurrence_subset,
            py::arg("col_indices"),
            py::arg("threshold") = 0.95,
            py::arg("threads") = 1)
